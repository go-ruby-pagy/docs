...
The public API lives at the module root (`github.com/go-ruby-pagy/pagy`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `pagy`, while the surface follows
...
```go
import "github.com/go-ruby-pagy/pagy"
```
...
- **[pkg.go.dev/github.com/go-ruby-pagy/pagy](https://pkg.go.dev/github.com/go-ruby-pagy/pagy)**

The module's [README](https://github.com/go-ruby-pagy/pagy#readme) carries worked
