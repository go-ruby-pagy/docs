# go-ruby-pagy documentation

**Pure-Go Pagy: fast pagination calculator, CGO=0 — bound into rbgo**

`go-ruby-pagy/pagy` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `pagy`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-pagy/pagy`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `pagy`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-pagy/pagy
```
...
| Repo | What it is |
| --- | --- |
| [`pagy`](https://github.com/go-ruby-pagy/pagy) | the library — Ruby's `pagy` in pure Go |
| [`docs`](https://github.com/go-ruby-pagy/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-pagy.github.io`](https://github.com/go-ruby-pagy/go-ruby-pagy.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-pagy/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-pagy/pagy](https://github.com/go-ruby-pagy/pagy).
