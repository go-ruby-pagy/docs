...
Contributions are welcome. `go-ruby-pagy/pagy` is built to a small set of
...
The library is in [`github.com/go-ruby-pagy/pagy`](https://github.com/go-ruby-pagy/pagy).
This documentation site is in [`github.com/go-ruby-pagy/docs`](https://github.com/go-ruby-pagy/docs).
